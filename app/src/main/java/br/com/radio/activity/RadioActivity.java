...
public class RadioActivity extends AppCompatActivity implements RadioListener , OnFragmentInteractionListener {
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem instanceof Nameable) {
                            tb.setTitle(((Nameable) drawerItem).getName().getText(RadioActivity.this));
                        }
